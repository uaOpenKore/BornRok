...
// Vendored verbatim (held disabled — see Gr2.cpp). Silence MSVC's narrowing/shadowing warnings for
// this third-party decoder rather than diverge from upstream: C4244/C4267 (int<->uint16 narrowing),
// C4456/C4458 (local/member shadowing). The GCC/Clang build does not flag these.
#ifdef _MSC_VER
#pragma warning(push)
#pragma warning(disable : 4244 4267 4456 4458)
#endif
